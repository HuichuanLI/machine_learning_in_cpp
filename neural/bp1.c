...
void print(double wh[HIDDENNO][INPUTNO + 1], double wo[HIDDENNO + 1]); /*输出结果*/
double forward(double wh[HIDDENNO][INPUTNO + 1], double wo[HIDDENNO + 1], double hi[], double e[INPUTNO + 1]); /*前向计算*/
void olearn(double wo[HIDDENNO + 1], double hi[], double e[INPUTNO + 1], double o); /*输出层权重的调整*/
int getdata(double e[][INPUTNO + 1]); /*读入学习数据*/
void hlearn(double wh[HIDDENNO][INPUTNO + 1], double wo[HIDDENNO + 1], double hi[], double e[INPUTNO + 1],
            double o); /*中间层权重的调整*/
