...
/*函数原型的声明*/
void conv(double filter[FILTERSIZE][FILTERSIZE], double e[][INPUTSIZE], double convout[][INPUTSIZE]); /*卷积计算*/
...
/*池化计算*/
double maxpooling(double convout[][INPUTSIZE], int i, int j);/* 最大值池化 */
int getdata(double e[][INPUTSIZE][INPUTSIZE], int r[]);/*读入数据*/
void showdata(double e[][INPUTSIZE][INPUTSIZE], int t[], int n_of_e);/*数据表示*/
...
double forward(double wh[HIDDENNO][POOLOUTSIZE * POOLOUTSIZE * FILTERNO + 1], double wo[HIDDENNO + 1], double hi[],
               double e[POOLOUTSIZE * POOLOUTSIZE * FILTERNO + 1]); /*前向计算*/
void
olearn(double wo[HIDDENNO + 1], double hi[], double e[POOLOUTSIZE * POOLOUTSIZE * FILTERNO + 1], double o); /*输出层权重的调整*/
void hlearn(double wh[HIDDENNO][POOLOUTSIZE * POOLOUTSIZE * FILTERNO + 1], double wo[HIDDENNO + 1], double hi[],
            double e[POOLOUTSIZE * POOLOUTSIZE * FILTERNO + 1], double o); /*中间层权重的调整*/
double f(double u); /*传递函数（sigmoid函数）*/
void print(double wh[HIDDENNO][POOLOUTSIZE * POOLOUTSIZE * FILTERNO + 1], double wo[HIDDENNO + 1]); /*结果的输出*/
